      ...
      <div className="container relative mx-auto px-4 w-3/4">
        ...
        <div className="mb-14 text-center">
          <span className="flex justify-center gap-12 ">
            {" "}
            <p className="mb-6 text-5xl font-bold tracking-tight bg-clip-text text-cyan-400 md:text-6xl lg:text-7xl">
              /
            </p>
            <h2 className="mb-6 text-5xl font-regular  text-white/90 md:text-6xl lg:text-7xl tracking-wider ">
              BENEFIT FROM US
            </h2>
            <p className="mb-6 text-5xl font-bold tracking-tight text-cyan-400 md:text-6xl lg:text-7xl">
              /
            </p>
          </span>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <Card
              key={index}
              className="group border-cyan-950 bg-black/50 transition-colors hover:border-cyan-400/50"
            >
